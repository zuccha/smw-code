...
| ![All dragon coins collected with default text](./docs/sb-dragon-coins-default.gif) |
| :---------------------------------------------------------------------------------: |
...
| ![All dragon coins collected with custom text](./docs/sb-dragon-coins-custom.gif) |
| :-------------------------------------------------------------------------------: |
