...
| ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| [Byte Converter](./tools/byte_converter)                   | [v1.4.0](https://github.com/zuccha/smw-code/releases/download/tool%2Fbyte_converter%2F1.4.0/byte_converter-1.4.0.zip)       | [Online](https://zuccha.io/pages/byte_converter.html)    |
